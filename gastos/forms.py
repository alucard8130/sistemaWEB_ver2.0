...
class GastoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "retencion_iva": forms.NumberInput(attrs={"class": "form-control"}),
            "retencion_isr": forms.NumberInput(attrs={"class": "form-control"}),
        ...
        if user:
            if user.is_superuser:
                ...
                if empresa:
                    ...
                    self.fields["tipo_gasto"].queryset = TipoGasto.objects.filter(
                        empresa=empresa
                    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "monto": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Monto"}
            ),
