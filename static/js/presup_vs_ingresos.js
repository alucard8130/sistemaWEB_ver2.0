$(document).ready(function() {
    ...
    // Get the number of months from the attribute data
    var mesesCount = parseInt(document.getElementById('table-container-corp').dataset.mesesCount);
    console.log("mesesCount:", mesesCount);
